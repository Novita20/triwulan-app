                    ...
                    <form method="POST" action="{{ $url_form }}">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control @error('tahun') is-invalid @enderror" name="tahun">
                                ...
                                @for ($tahun = $currentYear; $tahun >= $startYear; $tahun--)
                                    <option value="{{ $tahun }}"
                                        {{ isset($master_program) && $master_program->tahun == $tahun ? 'selected' : '' }}>
                                        {{ $tahun }}</option>
                                @endfor
                            </select>
                            @error('tahun')
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control @error('no_rekening') is-invalid @enderror"
                                value="{{ isset($master_program) ? $master_program->no_rekening : old('no_rekening') }}"
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control @error('nama_program') is-invalid @enderror"
                                value="{{ isset($master_program) ? $master_program->nama_program : old('nama_program') }}"
